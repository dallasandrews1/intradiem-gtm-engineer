...
**Star Ratings humility clause (mandatory for Stars copy).** Public CMS math is an outside estimate. Every Stars message that cites a computed number carries a version of "you will know the exact picture far better than I do." Confidence about the mechanism, humility about their internal numbers. This is the tone of the motion's gold-standard sample: the Jul 9 2026 Point32/Kristen Dowd rewrite (Message_Variant_Starter_Pack.md, variant 1A). The older onboarding-site version of that message is SUPERSEDED; its "I would value 15 minutes" CTA is banned.
...
- "Throwing more people at the metric has stalled, and the pure-AI pilots did not move it either; the lever left is orchestrating the workforce they already pay for." (The platform one-idea family, from Naveen's own framing: DWO delivers what pure human and pure AI investments have both failed on.)
...
**SENTENCE FLOW (cadence, outranks every rule below except the number and claim rules).** The biggest tell that a machine wrote this is not a banned word, it is cramming several facts into one sentence with commas. Avoid that harder than any word on the forbidden list.
...
- Vary length on purpose. At least one sentence in the message is under six words. Never write three sentences in a row of the same shape and length.
- No metaphors or decorative phrases. Say the literal thing. Banned in prose specifically: "the climb," "sequencing," "cliff-edge" (the data token is fine, the word in a sentence is not), "the ground you move," "spark," "north star." Cut any sentence that adds flavor but no new fact.
- Plain words over precise-sounding ones. "sits at 3.0 stars this cycle" becomes "is at 3.0 stars right now." "a full star under the 4.0 bonus line" survives only as its own short sentence. Say it the way you would say it out loud.
...
Match the AFTER cadence, never the BEFORE:

- BEFORE (dense, AI): "CalOptima OneCare sits at 3.0 stars this cycle, a full star under the 4.0 bonus line, with no cliff-edge contract in the mix, so the climb has to be multi-year." AFTER: "CalOptima OneCare is at 3.0 stars right now. That's a full star under the 4.0 bonus line, and closing it is a multi-year job, not a one-cycle fix."
- BEFORE (reached-for close): "Worth 15 minutes on how you're sequencing the climb?" AFTER: "Worth 15 minutes on how you're planning the next couple of cycles?"
- BEFORE (dense): "Shawn, half a star separates Medica's contracts from the 4.0 bonus line, at 3.5 overall across 3 contracts. The clinical side, at 3.6, isn't the blocker." AFTER: "Shawn, Medica's three contracts sit at 3.5. That's half a star under the 4.0 bonus line. Your clinical stars are already at 3.6, so that isn't the blocker. The gap is on the service side."

This is the single source of the cadence standard. The Clay MessageGen prompts carry a verbatim SENTENCE FLOW block and the `voice_audit` critic enforces it; keep all copies identical so the engine gate and this thinking layer never drift.
...
- **The Seller-Want CTA (banned):** never "I would value / I'd value 15 minutes." It states what the sender wants; the meeting must read as the prospect's payoff, their idea to take.
- **Natural speech, always:** contractions everywhere (I'd, I'm, you'll); "I would" and "I am" never appear in cold copy. Default CTA patterns: "Thought it might be worth finding time to ___. Have 15 minutes ___?" and "Might be worth 15 minutes on ___. Open to it?"
- **Banned CTA phrasings:** "trade notes," "trading notes," "compare notes," "comparing notes," "pick your brain," "touch base." Use natural verbs like "talk through" or "walk through" instead.
