...
The one concrete sentence E1 uses to say what Intradiem does in this motion, on top of what the prospect already runs. Intradiem named once. Concrete actions, never a category label. Rewrite it from Naveen's messaging document when it lands. Back-office source: `04-value-repository/BOO_Messaging_Framework_Jun26.md` (marketing, Jun 26 2026). Marketing's own line: "Back Office Optimizer shows you exactly how much work is piling up, whether your staff can handle it, and which case each worker should tackle next, before you miss an SLA or pay a penalty." Front office and DWO: the VERIFIED value-deck claims in the Value Repository. Never write the product sentence from memory; copy it from the source and trim.
