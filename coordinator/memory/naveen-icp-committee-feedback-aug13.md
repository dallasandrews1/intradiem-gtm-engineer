---
name: naveen-icp-committee-feedback-aug13
description: "Naveen's Aug 13 2026 feedback, ICP buying-committee deliverable was a massive hit with leadership, Haresh (President of Partnerships) meeting incoming, marketing folded in, Dallas given full credit"
metadata: 
  node_type: memory
  type: project
...
**How to apply:** treat the ICP buying-committee format as the proven flagship deliverable shape. Before the Haresh meeting, prep a partnerships-angle version (which partners touch which committee personas). Expect inbound asks from sales reps and marketing referencing the widget; route them through the self-serve skill framing per house rules (Dallas maintains tools, never ghostwrites in the loop). Related: [[swarm-blackout-fixed-guarded-shim-aug15]] (the swarm must be reliable now that leadership is watching).
