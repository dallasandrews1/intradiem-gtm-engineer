...
**Addendum (Aug 27):** process-step descriptions are full plain sentences that say what happens ("Build the list, take out current customers, check every email, and count what's left."), never comma fragments ("The list, customers out, verified email, a count."); owner cells are roles, never tool names.
