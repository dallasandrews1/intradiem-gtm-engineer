...
**Deletions done Sep 5 late (Dallas):** Stars table columns removed (91 -> 55): MessageGen, Msg1 outputs, Sync Leads x2, Draft/Voice Audit, critic status, send_ready, human_approved. Live workflows still valid. Remaining deletable: six gate/critic Functions, seven Alpha/Pilot workflows; Invoke Workflow, customer_exclude, Lookup Single Row x2 still on the table (hide in the demo view).
Claygents page still holds all 37 (Stars/WFM MessageGen E1-E5 and LinkedIn, Figure Critics, Voice Audit/Fix, Reply Triage/Draft, Cost-Mandate and WFM MessageGen Email1) as of Sep 5 late; every one is on the retirement list.
