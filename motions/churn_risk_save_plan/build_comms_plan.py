...
ROUTES = [
 ...
 {"id": "exec-voice", "name": "The executive voice, held", "via": "Matt McConnell to Dennis Laraway or Bill Peacock, naming Rena and Scott Faini as the engaged team",
  "why": "A different voice at the top, the move that turned the ADT renewal. Held until the savings method is agreed with Shantel, because a disputed number at the CFO speeds the exit.", "lane": "Executive voice", "adt": "ADT: CEO outreach, Matt McConnell as a different voice"},
...
out = {"account": "Cleveland Clinic", "as_of": "2026-09-11", "precedent": "ADT save play, PMO Progress tracker export (Nov 2024 to Feb 2025): CEO outreach, high-and-wide marketing, customer references, partners, voice of the customer, renewal track",
       ...
       "marketing_lane": {
         "list": "Cleveland Clinic - Verified List for Nicole - Sep 11.csv (Inger passes it to Nicole): 4 IT and RFP names with checked emails, 56 Salesforce contact-center and IT records labeled as marketing's own data, not re-verified; sponsor line, executives, back-office and clinical names left out",
         "tool": "Pardot, sent as Amy Johnson's alias; nothing account-specific from marketing",
         "sends": ["Oct 6: one-pager 1", "Nov 3: one-pager 2 and voice-of-customer alignment to every executive contact in Salesforce", "Dec 1: one-pager 3"],
         "claims_in": ["Humana by name: partnership since 2020, 7X ROI five years in, about 2 hours of capacity per agent per month in 2025, AHT down 45 seconds (Value Repository, verified)",
                       "Cleveland Clinic's own August adoption numbers, when addressed to Cleveland Clinic: 79.6% coaching acceptance, 93.8% AUX self-cure, 4,461 leave-early offers accepted",
                       ...
                       "A 2022 Forrester study: 342 percent ROI"],
         "claims_out": ["The $719K YTD savings and 1.9x figures, until the method is agreed with the customer",
                        "Any customer name other than Humana, Virgin Media or Optum", "Any idle-time percentage", "Any implementation timeline"]},
